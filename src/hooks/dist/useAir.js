...
function useAir() {
    var _a = react_1.useState(false), defaultOpen = _a[0], setDefaultOpen = _a[1];
    var _b = react_1.useState(''), defaultCode = _b[0], setDefaultCode = _b[1];
    var _c = react_1.useState(0), defaultWidth = _c[0], setDefaultWidth = _c[1];
